...
class ModelsTestCase(TestCase):
    ...
    def test_Package_model(self):
        ...
        package = Package.objects.create(author='Test author', title="Test title")
        self.assertEqual(package.title, 'Test title')

# views.py - without fixtures
class ViewsTestCase(TestCase):
    ...
    def test_options_json_site(self): 
        ...
        self.assertEqual(response.status_code, 200) #empty page / JSON = 404?
